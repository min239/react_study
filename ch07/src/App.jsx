...
function App() {
   ...
   */
   ...
   const onRemove = useCallback(
      (id) => {
         /*두전째 지우면 ID2번을 지움 todo.id != id 2번과 같지 않은 거는 ㅊ참  removeTodos  {
         id: 1,
         text: '헬스장 가기',
         checked: true,
      },
   ...
   return (
      <TodoTemplate>
         {/*todoinsert 컴포넌트에서 할일을 등록하므로 oninsert함수를 props로 전달 */}
         <TodoInsert onInsert={onInsert} />
         {/*TdoListItem컴포넌트에서 삭제하므로 onremove 함수를 props로 전달 */}
